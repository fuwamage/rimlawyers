...
<body>
    ...
    <section class="py-10 bg-[#F2F2F2]">
        <div class="container py-12">
            ...
            <h2 class="text-2xl text-center text-rim-title font-aoboshi-one  dark:text-white mb-6 capitalize">Our Legal
                Practice Areas</h2>
                    ...
                    <div class="hidden duration-700 ease-in-out" data-carousel-item>
                        <div class="container flex max-w-[900px] flex-wrap">
                            ...
                            <div
                                ...
                                <a href="#">
                                    <h5
                                        class="mb-2 text-[16px] font-roboto tracking-tight text-gray-900 dark:text-white group-hover:text-white">
                                        Corporate law and <br>Corporate Restructuring</h5>
                                </a>
                                <p
                                    ...
                                    legal matters that company is dealing with</p>
                            </div>
                            {{-- Capital Market --}}
                            <div
                                class="group hover:bg-orange-rim max-w-[256px] max-h-[205px] px-3 py-4 bg-white border border-gray-200 shadow mr-4 ml-4 mt-4 mb-4">
                                ...
                                <p
                                    class="mt-[-5px] font-inter text-[12px] text-gray-500 dark:text-gray-400 group-hover:text-white">
                                    There are many laws that concern managing a business because there are many aspects
                                    invloved in managing. Running a business</p>
                            </div>
                            ...
                            <div
                                ...
                                <a href="#">
                                    <h5
                                        class="mb-2 text-[16px] font-roboto tracking-tight text-gray-900 dark:text-white group-hover:text-white">
                                        Foreign and Domestic Investment</h5>
                                </a>
                                <p
                                    class="mt-[-5px] font-inter text-[12px] text-gray-500 dark:text-gray-400 group-hover:text-white">
                                    There are many laws that concern managing a business because there are many aspects
            ...
            <div class="container flex ">
                ...
                <div class="container mt-[-40px]">
                    <div class="container ">
                        ...
                        <h2
                            class="text-2xl text-left text-rim-title font-aoboshi-one  dark:text-white mb-6 capitalize">
                            Why Choose
                            Us?</h2>
                    </div>
                    <div class="container flex">
                        ...
                        <div class="container">
                            ...
                            <p class="font-inter text-[#5A6FA5] max-w-[390px] text-[12px]">As a leading law firm,we are
                                giving solutions for business, family, finance, real estate,
                                divorce etc.</p>
                        </div>
                    </div>
                    <div class="container flex">
                        ...
                        <div class="container">
                            ...
                            <p class="font-inter text-[#5A6FA5] max-w-[390px] text-[12px]">We earn trust and respect
                                from others by living and working according to time-honored
                    ...
                    <div class="container flex">
                        ...
                        <div class="container">
                            ...
                            <p class="font-inter text-[#5A6FA5] max-w-[390px] text-[12px]">Generally, unless the work
                                undertaken is governed by a fixed tariff, we would normally
